...
import com.yyp.coolweather.gson.Forecast;
import com.yyp.coolweather.gson.Weather;
import com.yyp.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pictureImg = (ImageView) findViewById (R.id.iv_picture);
        ...
        if (picture != null) {
            Glide.with (this).load (picture).into (pictureImg);
        } else {
            loadPicture ();
        }
    ...
    private void loadPicture() {
        String requstPicture = "http://guolin.tech/api/bing_pic";
        HttpUtil.sendOkHttpRequest (requstPicture, new Callback () {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread (() -> {
                    Toast.makeText (WeatherActivity.this, "服务器获取加载图片失败ppppp", Toast.LENGTH_SHORT)
                            .show ();
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                editor.apply ();
                runOnUiThread (() -> {
                    Glide.with (WeatherActivity.this).load (bingPicture).into (pictureImg);
                    Toast.makeText (WeatherActivity.this, "服务器获取加载图片成功ccccccc", Toast
                            .LENGTH_SHORT).show ();
                });
            }
        });
